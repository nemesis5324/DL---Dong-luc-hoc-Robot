...
#include "c3_TwoDOF_PID_joint_space.h"
...
static const char * c3_debug_family_names[15] = { "L1", "L2", "q1", "q2", "c1",
  "s1", "c12", "s12", "J", "nargin", "nargout", "Q", "V", "invJ", "Qp" };

/* Function Declarations */
static void initialize_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void initialize_params_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void enable_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void disable_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void set_sim_state_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void sf_gateway_c3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void initSimStructsc3_TwoDOF_PID_joint_space
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_Qp, const char_T *c3_identifier, real_T
  c3_y[2]);
static void c3_b_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_invJ, const char_T *c3_identifier, real_T
  c3_y[4]);
static void c3_d_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[4]);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_e_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void c3_mpower(SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance,
                      real_T c3_a[4], real_T c3_c[4]);
static void c3_inv2x2(SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance,
                      real_T c3_x[4], real_T c3_y[4]);
static real_T c3_norm(SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance,
                      real_T c3_x[4]);
static void c3_eml_warning(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
static void c3_b_eml_warning(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, char_T c3_varargin_2[14]);
static void c3_eml_scalar_eg(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
static void c3_eml_xgemm(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, real_T c3_A[4], real_T c3_B[2], real_T c3_C[2], real_T c3_b_C
  [2]);
static void c3_f_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_sprintf, const char_T *c3_identifier, char_T
  c3_y[14]);
static void c3_g_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  char_T c3_y[14]);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_h_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_i_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_TwoDOF_PID_joint_space, const
  char_T *c3_identifier);
static uint8_T c3_j_emlrt_marshallIn(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_eml_xgemm(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, real_T c3_A[4], real_T c3_B[2], real_T c3_C[2]);
static void init_dsm_address_info(SFc3_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
  ...
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_TwoDOF_PID_joint_space = 0U;
}
  ...
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance)
{
  ...
  real_T (*c3_invJ)[4];
  real_T (*c3_Qp)[2];
  c3_Qp = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c3_invJ = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(3, 1), false);
  for (c3_i0 = 0; c3_i0 < 2; c3_i0++) {
    c3_u[c3_i0] = (*c3_Qp)[c3_i0];
  }
  ...
  for (c3_i1 = 0; c3_i1 < 4; c3_i1++) {
    c3_b_u[c3_i1] = (*c3_invJ)[c3_i1];
  }

  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", c3_b_u, 0, 0U, 1U, 0U, 2, 2, 2),
                false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_TwoDOF_PID_joint_space;
   ...
   *c3_st)
{
  ...
  c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)), "Qp",
                      c3_dv0);
  for (c3_i2 = 0; c3_i2 < 2; c3_i2++) {
    (*c3_Qp)[c3_i2] = c3_dv0[c3_i2];
  }

  c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
                        "invJ", c3_dv1);
  for (c3_i3 = 0; c3_i3 < 4; c3_i3++) {
    (*c3_invJ)[c3_i3] = c3_dv1[c3_i3];
  }

  chartInstance->c3_is_active_c3_TwoDOF_PID_joint_space = c3_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_TwoDOF_PID_joint_space");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_TwoDOF_PID_joint_space(chartInstance);
  ...
  (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance)
{
  ...
  real_T (*c3_b_V)[2];
  real_T (*c3_b_Q)[2];
  c3_b_Qp = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c3_b_V = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_invJ = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c3_i4 = 0; c3_i4 < 2; c3_i4++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_Q)[c3_i4], 0U);
  }
  ...
  for (c3_i6 = 0; c3_i6 < 2; c3_i6++) {
    c3_V[c3_i6] = (*c3_b_V)[c3_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 15U, 15U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_L1, 0U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_L2, 1U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_q1, 2U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_q2, 3U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_c1, 4U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_s1, 5U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_c12, 6U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_s12, 7U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_J, 8U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 10U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_Q, 11U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_V, 12U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_invJ, 13U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_Qp, 14U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_b_x = c3_c1;
  c3_c1 = c3_b_x;
  c3_c1 = muDoubleScalarCos(c3_c1);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 7);
  c3_c_x = c3_q1;
  c3_s1 = c3_c_x;
  c3_d_x = c3_s1;
  c3_s1 = c3_d_x;
  c3_s1 = muDoubleScalarSin(c3_s1);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 8);
  c3_e_x = c3_q1 + c3_q2;
  c3_c12 = c3_e_x;
  c3_f_x = c3_c12;
  c3_c12 = c3_f_x;
  c3_c12 = muDoubleScalarCos(c3_c12);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 9);
  c3_g_x = c3_q1 + c3_q2;
  c3_s12 = c3_g_x;
  c3_h_x = c3_s12;
  c3_s12 = c3_h_x;
  c3_s12 = muDoubleScalarSin(c3_s12);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 10);
  c3_J[0] = -0.1442 * c3_s12 - 0.2 * c3_s1;
  c3_J[2] = -0.1442 * c3_s12;
  c3_J[1] = 0.1442 * c3_c12 + 0.2 * c3_c1;
  c3_J[3] = 0.1442 * c3_c12;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 12);
  for (c3_i7 = 0; c3_i7 < 4; c3_i7++) {
    c3_b_J[c3_i7] = c3_J[c3_i7];
  }

  c3_mpower(chartInstance, c3_b_J, c3_a);
  for (c3_i8 = 0; c3_i8 < 2; c3_i8++) {
    c3_b[c3_i8] = c3_V[c3_i8];
  }
  ...
  c3_b_eml_xgemm(chartInstance, c3_dv4, c3_dv5, c3_Qp);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 13);
  for (c3_i15 = 0; c3_i15 < 4; c3_i15++) {
    c3_c_J[c3_i15] = c3_J[c3_i15];
  }

  c3_mpower(chartInstance, c3_c_J, c3_dv6);
  for (c3_i16 = 0; c3_i16 < 4; c3_i16++) {
    c3_invJ[c3_i16] = c3_dv6[c3_i16];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -13);
  _SFD_SYMBOL_SCOPE_POP();
  for (c3_i17 = 0; c3_i17 < 4; c3_i17++) {
    (*c3_b_invJ)[c3_i17] = c3_invJ[c3_i17];
  }

  for (c3_i18 = 0; c3_i18 < 2; c3_i18++) {
    (*c3_b_Qp)[c3_i18] = c3_Qp[c3_i18];
  }
  ...
  for (c3_i19 = 0; c3_i19 < 4; c3_i19++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_invJ)[c3_i19], 1U);
  }

  for (c3_i20 = 0; c3_i20 < 2; c3_i20++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_V)[c3_i20], 2U);
  }

  for (c3_i21 = 0; c3_i21 < 2; c3_i21++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_Qp)[c3_i21], 3U);
  }
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i22 = 0; c3_i22 < 2; c3_i22++) {
    c3_b_inData[c3_i22] = (*(real_T (*)[2])c3_inData)[c3_i22];
  }
  ...
  c3_y[2])
{
  ...
  c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_Qp), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_Qp);
}
  ...
  real_T c3_y[2])
{
  ...
  int32_T c3_i24;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv7, 1, 0, 0U, 1, 0U, 1, 2);
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *)chartInstanceVoid;
  c3_Qp = sf_mex_dup(c3_mxArrayInData);
  ...
  for (c3_i25 = 0; c3_i25 < 2; c3_i25++) {
    (*(real_T (*)[2])c3_outData)[c3_i25] = c3_y[c3_i25];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i27 = 0; c3_i27 < 2; c3_i27++) {
    for (c3_i28 = 0; c3_i28 < 2; c3_i28++) {
      c3_b_inData[c3_i28 + c3_i26] = (*(real_T (*)[4])c3_inData)[c3_i28 + c3_i26];
    }
  ...
  c3_y[4])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_invJ), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_invJ);
}
  ...
  real_T c3_y[4])
{
  ...
  int32_T c3_i32;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv8, 1, 0, 0U, 1, 0U, 2, 2, 2);
  for (c3_i32 = 0; c3_i32 < 4; c3_i32++) {
    c3_y[c3_i32] = c3_dv8[c3_i32];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *)chartInstanceVoid;
  c3_invJ = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_invJ), &c3_thisId, c3_y);
  ...
  for (c3_i34 = 0; c3_i34 < 2; c3_i34++) {
    for (c3_i35 = 0; c3_i35 < 2; c3_i35++) {
      (*(real_T (*)[4])c3_outData)[c3_i35 + c3_i33] = c3_y[c3_i35 + c3_i33];
    }
...
const mxArray *sf_c3_TwoDOF_PID_joint_space_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m!matrix_to_integer_power"),
                  "context", "context", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("inv"), "name", "name", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("norm"), "name", "name", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!mat1norm"),
                  "context", "context", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!mat1norm"),
                  "context", "context", 26);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 26);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 32);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eps"), "name", "name", 32);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_eps"), "name", "name", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_flt2str.m"), "context",
                  "context", 37);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "name", "name", 37);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
                      ...
                      real_T c3_a[4], real_T c3_c[4])
{
  ...
  c3_inv2x2(chartInstance, c3_b_a, c3_c);
  for (c3_i37 = 0; c3_i37 < 4; c3_i37++) {
    c3_c_a[c3_i37] = c3_a[c3_i37];
  }
  ...
  if (c3_n1x == 0.0) {
    ...
    if (guard3 == true) {
      ...
      sf_mex_assign(&c3_d_y, sf_mex_create("y", &c3_d_u, 0, 0U, 0U, 0U, 0),
                    false);
      c3_f_emlrt_marshallIn(chartInstance, sf_mex_call_debug
  ...
  while ((exitg1 == false) && (c3_j < 2)) {
    ...
    for (c3_i = 0; c3_i < 2; c3_i++) {
      ...
      c3_b_x = c3_x[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
                      ("", c3_b_i), 1, 2, 1, 0) + ((_SFD_EML_ARRAY_BOUNDS_CHECK(
        "", (int32_T)_SFD_INTEGER_CHECK("", c3_b_j), 1, 2, 2, 0) - 1) << 1)) - 1];
      c3_c_x = c3_b_x;
  ...
  *chartInstance)
{
  ...
  const mxArray *c3_y = NULL;
  (void)chartInstance;
  for (c3_i41 = 0; c3_i41 < 27; c3_i41++) {
    c3_u[c3_i41] = c3_varargin_1[c3_i41];
  }
  ...
  char_T c3_y[14])
{
  ...
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_cv1, 1, 10, 0U, 1, 0U, 2, 1,
                14);
  for (c3_i47 = 0; c3_i47 < 14; c3_i47++) {
    c3_y[c3_i47] = c3_cv1[c3_i47];
  }
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_TwoDOF_PID_joint_space), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_TwoDOF_PID_joint_space);
  return c3_y;
}
  ...
  *chartInstance, real_T c3_A[4], real_T c3_B[2], real_T c3_C[2])
{
  ...
  for (c3_i49 = 0; c3_i49 < 2; c3_i49++) {
    ...
    for (c3_i51 = 0; c3_i51 < 2; c3_i51++) {
      c3_C[c3_i49] += c3_A[c3_i50 + c3_i49] * c3_B[c3_i51];
      c3_i50 += 2;
    }
  }
}
...
void sf_c3_TwoDOF_PID_joint_space_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1724849373U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2730516401U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1993836935U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2194442989U);
}

mxArray *sf_c3_TwoDOF_PID_joint_space_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("V0yKlKlXDThRVrulH3HkgD");
...
mxArray *sf_c3_TwoDOF_PID_joint_space_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_TwoDOF_PID_joint_space_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_TwoDOF_PID_joint_space(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[7],T\"Qp\",},{M[1],M[5],T\"invJ\",},{M[8],M[0],T\"is_active_c3_TwoDOF_PID_joint_space\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_TwoDOF_PID_joint_space_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c3_Qp)[2];
          c3_Qp = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
          c3_V = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
          c3_invJ = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
          c3_Q = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c3_Q);
          _SFD_SET_DATA_VALUE_PTR(1U, *c3_invJ);
          _SFD_SET_DATA_VALUE_PTR(2U, *c3_V);
          _SFD_SET_DATA_VALUE_PTR(3U, *c3_Qp);
        }
      }
    } else {
...
{
  return "NsPQs9zO0wQMoEB7MwtKRD";
}

static void sf_opaque_initialize_c3_TwoDOF_PID_joint_space(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_TwoDOF_PID_joint_space
    ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
  initialize_c3_TwoDOF_PID_joint_space
    ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  enable_c3_TwoDOF_PID_joint_space((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  disable_c3_TwoDOF_PID_joint_space((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  sf_gateway_c3_TwoDOF_PID_joint_space
    ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_TwoDOF_PID_joint_space
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_TwoDOF_PID_joint_space
    ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_TwoDOF_PID_joint_space();/* state var info */
...
extern void sf_internal_set_sim_state_c3_TwoDOF_PID_joint_space(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_TwoDOF_PID_joint_space();/* state var info */
  ...
  set_sim_state_c3_TwoDOF_PID_joint_space
    ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_TwoDOF_PID_joint_space
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_TwoDOF_PID_joint_space(S);
}

static void sf_opaque_set_sim_state_c3_TwoDOF_PID_joint_space(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_TwoDOF_PID_joint_space(S, st);
}

static void sf_opaque_terminate_c3_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_TwoDOF_PID_joint_space
      ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_TwoDOF_PID_joint_space
    ((SFc3_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_TwoDOF_PID_joint_space(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_TwoDOF_PID_joint_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1782762600U));
  ssSetChecksum1(S,(65251989U));
  ssSetChecksum2(S,(2061797179U));
  ssSetChecksum3(S,(3892922207U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_TwoDOF_PID_joint_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_TwoDOF_PID_joint_space(SimStruct *S)
{
  SFc3_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_TwoDOF_PID_joint_spaceInstanceStruct *)utMalloc(sizeof
    (SFc3_TwoDOF_PID_joint_spaceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_TwoDOF_PID_joint_spaceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_TwoDOF_PID_joint_space;
...
void c3_TwoDOF_PID_joint_space_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_TwoDOF_PID_joint_space(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_TwoDOF_PID_joint_space(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_TwoDOF_PID_joint_space(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_TwoDOF_PID_joint_space_method_dispatcher.\n"
