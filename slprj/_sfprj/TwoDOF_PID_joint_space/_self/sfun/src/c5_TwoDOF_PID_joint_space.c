...
#include "c5_TwoDOF_PID_joint_space.h"
...
static const char * c5_debug_family_names[12] = { "L1", "L2", "x", "y", "q2",
  "q1", "k", "nargin", "nargout", "P", "Qt", "Q" };

static const char * c5_b_debug_family_names[11] = { "L1x", "L1y", "q", "nargin",
  "nargout", "x", "y", "L1", "L2", "q2", "q1" };

/* Function Declarations */
static void initialize_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void initialize_params_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void enable_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void disable_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void set_sim_state_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void sf_gateway_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void c5_chartstep_c5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void initSimStructsc5_TwoDOF_PID_joint_space
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c5_Q, const char_T *c5_identifier, real_T c5_y
  [2]);
static void c5_b_emlrt_marshallIn(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
...
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static real_T c5_mpower(SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance,
  real_T c5_a);
static void c5_eml_scalar_eg(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
static void c5_eml_error(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
static real_T c5_cmp(SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance,
                     real_T c5_x, real_T c5_y, real_T c5_L1, real_T c5_L2,
                     real_T c5_q2);
static void c5_eml_warning(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_TwoDOF_PID_joint_space, const
  char_T *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_TwoDOF_PID_joint_spaceInstanceStruct
  *chartInstance);
  ...
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_TwoDOF_PID_joint_space = 0U;
}
   ...
   *c5_st)
{
  ...
  c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)), "Q",
                      c5_dv0);
  for (c5_i1 = 0; c5_i1 < 2; c5_i1++) {
    (*c5_Q)[c5_i1] = c5_dv0[c5_i1];
  }

  chartInstance->c5_is_active_c5_TwoDOF_PID_joint_space = c5_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_TwoDOF_PID_joint_space");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_TwoDOF_PID_joint_space(chartInstance);
  ...
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance)
{
  ...
  real_T (*c5_Q)[2];
  real_T (*c5_P)[2];
  c5_Qt = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  c5_Q = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_P = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c5_sfEvent);
  for (c5_i2 = 0; c5_i2 < 2; c5_i2++) {
    _SFD_DATA_RANGE_CHECK((*c5_P)[c5_i2], 0U);
  }

  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_TwoDOF_PID_joint_space(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_TwoDOF_PID_joint_spaceMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c5_i3 = 0; c5_i3 < 2; c5_i3++) {
    _SFD_DATA_RANGE_CHECK((*c5_Q)[c5_i3], 1U);
  }

  for (c5_i4 = 0; c5_i4 < 2; c5_i4++) {
    _SFD_DATA_RANGE_CHECK((*c5_Qt)[c5_i4], 2U);
  }
}
  ...
  (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance)
{
  ...
  boolean_T exitg1;
  boolean_T exitg2;
  c5_b_Qt = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  c5_b_Q = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_P = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c5_sfEvent);
  for (c5_i5 = 0; c5_i5 < 2; c5_i5++) {
    c5_P[c5_i5] = (*c5_b_P)[c5_i5];
  }

  for (c5_i6 = 0; c5_i6 < 2; c5_i6++) {
    c5_Qt[c5_i6] = (*c5_b_Qt)[c5_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 12U, 12U, c5_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_L1, 0U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_L2, 1U, c5_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_y, 3U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q2, 4U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q1, 5U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 8U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_P, 9U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_Qt, 10U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_Q, 11U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c5_A = ((c5_mpower(chartInstance, c5_x) + c5_mpower(chartInstance, c5_y)) -
          c5_mpower(chartInstance, 0.2)) - c5_mpower(chartInstance, 0.1442);
  c5_b_x = c5_A;
  c5_c_x = c5_b_x;
  c5_d_x = c5_c_x;
  c5_b_y = c5_d_x / 2.0;
  ...
  c5_l_x = muDoubleScalarAcos(c5_l_x);
  c5_q2 = -c5_l_x;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 7);
  c5_q1 = c5_cmp(chartInstance, c5_x, c5_y, 0.2, 0.1442, c5_q2);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 8);
  c5_k = 1.0;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 9);
  exitg2 = false;
  while ((exitg2 == false) && (c5_q1 < 0.0)) {
    c5_d_A = (2.0 * c5_k - 1.0) * 3.1415926535897931;
    c5_m_x = c5_d_A;
    c5_n_x = c5_m_x;
    c5_o_x = c5_n_x;
    c5_e_y = c5_o_x / 2.0;
    if (c5_Qt[0] > c5_e_y) {
      ...
      c5_q1 += 2.0 * c5_k * 3.1415926535897931;
  ...
  exitg1 = false;
  while ((exitg1 == false) && (c5_q1 >= 0.0)) {
    c5_e_A = (2.0 * c5_k + 1.0) * 3.1415926535897931;
    c5_p_x = c5_e_A;
    c5_q_x = c5_p_x;
    c5_r_x = c5_q_x;
    c5_f_y = c5_r_x / 2.0;
    if (c5_Qt[0] > c5_f_y) {
      if (c5_q1 <= 3.1415926535897931) {
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *)chartInstanceVoid;
  ...
  [2])
{
  ...
  c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_Q), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_Q);
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  for (c5_i11 = 0; c5_i11 < 2; c5_i11++) {
    (*(real_T (*)[2])c5_outData)[c5_i11] = c5_y[c5_i11];
  }
...
const mxArray *sf_c5_TwoDOF_PID_joint_space_get_eml_resolved_functions_info(void)
{
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("acos"), "name", "name", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343837566U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343837576U), "fileTimeLo",
                  "fileTimeLo", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("cos"), "name", "name", 23);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sin"), "name", "name", 25);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mldivide"), "name", "name", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1319737166U), "mFileTimeLo",
                  "mFileTimeLo", 27);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 27);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xcabs1.p"),
                  "context", "context", 31);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 31);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m!lusolve2x2"),
                  "context", "context", 34);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("rdivide"), "name", "name", 34);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs36), "lhs", "lhs",
                  36);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(""), "context", "context", 37);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("atan2"), "name", "name", 37);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
                     ...
                     real_T c5_q2)
{
  ...
  real_T c5_cb_x;
  boolean_T guard1 = false;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c5_b_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_L1x, 0U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_L1y, 1U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_q, 2U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 4U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_x, 5U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_y, 6U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_L1, 7U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_L2, 8U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q2, 9U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q1, 10U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  CV_EML_FCN(0, 1);
  ...
  c5_n_x = c5_m_x;
  c5_o_x = c5_n_x;
  c5_d_y = muDoubleScalarAbs(c5_o_x);
  c5_p_x = 0.0;
  c5_q_x = c5_p_x;
  c5_e_y = muDoubleScalarAbs(c5_q_x);
  ...
  c5_r_x = c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c5_r2), 1, 2, 1, 0) - 1];
  c5_f_y = c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c5_r1), 1, 2, 1, 0) - 1];
  c5_s_x = c5_r_x;
  c5_g_y = c5_f_y;
  c5_t_x = c5_s_x;
  c5_h_y = c5_g_y;
  c5_a21 = c5_t_x / c5_h_y;
  c5_a22 = c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c5_r2), 1, 2, 1, 0) + 1] - c5_a21 * c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK
    ("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c5_r1), 1, 2, 1, 0) + 1];
  guard1 = false;
  if (c5_a22 == 0.0) {
    guard1 = true;
  } else {
    if (c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c5_r1), 1, 2, 1, 0) - 1] == 0.0) {
      guard1 = true;
    }
  }
  ...
  c5_u_x = c5_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c5_r2), 1, 2, 1, 0) - 1] - c5_B[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c5_r1), 1, 2, 1, 0) - 1] * c5_a21;
  c5_i_y = c5_a22;
  c5_v_x = c5_u_x;
  c5_j_y = c5_i_y;
  c5_w_x = c5_v_x;
  ...
  c5_z = c5_w_x / c5_k_y;
  c5_q[1] = c5_z;
  c5_x_x = c5_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c5_r1), 1, 2, 1, 0) - 1] - c5_q[1] *
    c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
    c5_r1), 1, 2, 1, 0) + 1];
  c5_l_y = c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c5_r1), 1, 2, 1, 0) - 1];
  c5_y_x = c5_x_x;
  c5_m_y = c5_l_y;
  c5_ab_x = c5_y_x;
  c5_n_y = c5_m_y;
  c5_b_z = c5_ab_x / c5_n_y;
  c5_q[0] = c5_b_z;
  ...
  c5_p_y = c5_o_y;
  c5_cb_x = c5_bb_x;
  c5_q1 = muDoubleScalarAtan2(c5_p_y, c5_cb_x);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -23);
  _SFD_SYMBOL_SCOPE_POP();
  return c5_q1;
}
  ...
  *chartInstance)
{
  ...
  const mxArray *c5_y = NULL;
  (void)chartInstance;
  for (c5_i14 = 0; c5_i14 < 27; c5_i14++) {
    c5_u[c5_i14] = c5_varargin_1[c5_i14];
  }
  ...
  char_T *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_TwoDOF_PID_joint_space), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_TwoDOF_PID_joint_space);
  return c5_y;
}
...
void sf_c5_TwoDOF_PID_joint_space_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1211588582U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(127503208U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1674700769U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2150270676U);
}

mxArray *sf_c5_TwoDOF_PID_joint_space_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9iz0eYfvpM78oXAiuPRX1D");
...
mxArray *sf_c5_TwoDOF_PID_joint_space_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_TwoDOF_PID_joint_space_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_TwoDOF_PID_joint_space(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Q\",},{M[8],M[0],T\"is_active_c5_TwoDOF_PID_joint_space\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_TwoDOF_PID_joint_space_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,1,1,0,"Qt");
        ...
        _SFD_CV_INIT_EML(0,1,2,0,0,0,0,0,2,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,291);
        _SFD_CV_INIT_EML_FCN(0,1,"cmp",291,-1,404);
        _SFD_CV_INIT_EML_WHILE(0,1,0,124,160,193);
        _SFD_CV_INIT_EML_WHILE(0,1,1,199,246,279);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c5_Qt);
        }
      }
    } else {
...
{
  return "K7yDjDRi0AYhu3HHKEKQpH";
}

static void sf_opaque_initialize_c5_TwoDOF_PID_joint_space(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_TwoDOF_PID_joint_space
    ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
  initialize_c5_TwoDOF_PID_joint_space
    ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  enable_c5_TwoDOF_PID_joint_space((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  disable_c5_TwoDOF_PID_joint_space((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  sf_gateway_c5_TwoDOF_PID_joint_space
    ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_TwoDOF_PID_joint_space
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_TwoDOF_PID_joint_space
    ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_TwoDOF_PID_joint_space();/* state var info */
...
extern void sf_internal_set_sim_state_c5_TwoDOF_PID_joint_space(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_TwoDOF_PID_joint_space();/* state var info */
  ...
  set_sim_state_c5_TwoDOF_PID_joint_space
    ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_TwoDOF_PID_joint_space
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_TwoDOF_PID_joint_space(S);
}

static void sf_opaque_set_sim_state_c5_TwoDOF_PID_joint_space(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c5_TwoDOF_PID_joint_space(S, st);
}

static void sf_opaque_terminate_c5_TwoDOF_PID_joint_space(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_TwoDOF_PID_joint_space
      ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_TwoDOF_PID_joint_space
    ((SFc5_TwoDOF_PID_joint_spaceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_TwoDOF_PID_joint_space(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_TwoDOF_PID_joint_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3934766555U));
  ssSetChecksum1(S,(1938705223U));
  ssSetChecksum2(S,(2400309518U));
  ssSetChecksum3(S,(1174719310U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_TwoDOF_PID_joint_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_TwoDOF_PID_joint_space(SimStruct *S)
{
  SFc5_TwoDOF_PID_joint_spaceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_TwoDOF_PID_joint_spaceInstanceStruct *)utMalloc(sizeof
    (SFc5_TwoDOF_PID_joint_spaceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_TwoDOF_PID_joint_spaceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_TwoDOF_PID_joint_space;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_TwoDOF_PID_joint_space;
...
void c5_TwoDOF_PID_joint_space_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_TwoDOF_PID_joint_space(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_TwoDOF_PID_joint_space(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_TwoDOF_PID_joint_space(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_TwoDOF_PID_joint_space_method_dispatcher.\n"
