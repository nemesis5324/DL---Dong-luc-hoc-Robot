...
#include "c10_A2_TwoDOF_PID_task_space.h"
...
static void initialize_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void initialize_params_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void enable_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void disable_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void set_sim_state_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance, const mxArray
   *c10_st);
static void finalize_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void sf_gateway_c10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void initSimStructsc10_A2_TwoDOF_PID_task_space
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c10_X, const char_T *c10_identifier, real_T
  c10_y[2]);
static void c10_b_emlrt_marshallIn(SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *
...
static uint8_T c10_e_emlrt_marshallIn
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance, const mxArray
   *c10_b_is_active_c10_A2_TwoDOF_PID_task_space, const char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance, const mxArray
   *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance);
  ...
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_A2_TwoDOF_PID_task_space = 0U;
}
  ...
  (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_A2_TwoDOF_PID_task_space;
   ...
   *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_A2_TwoDOF_PID_task_space =
    c10_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
    "is_active_c10_A2_TwoDOF_PID_task_space");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_A2_TwoDOF_PID_task_space(chartInstance);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c10_A2_TwoDOF_PID_task_space_get_eml_resolved_functions_info
  (void)
{
   ...
   *c10_b_is_active_c10_A2_TwoDOF_PID_task_space, const char_T *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_A2_TwoDOF_PID_task_space), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_A2_TwoDOF_PID_task_space);
  return c10_y;
}
...
void sf_c10_A2_TwoDOF_PID_task_space_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_A2_TwoDOF_PID_task_space_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_A2_TwoDOF_PID_task_space_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_A2_TwoDOF_PID_task_space_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_A2_TwoDOF_PID_task_space(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"X\",},{M[8],M[0],T\"is_active_c10_A2_TwoDOF_PID_task_space\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_A2_TwoDOF_PID_task_space_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c10_A2_TwoDOF_PID_task_space(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
  initialize_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_A2_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  enable_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_A2_TwoDOF_PID_task_space(void
  *chartInstanceVar)
{
  disable_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_A2_TwoDOF_PID_task_space(void
  *chartInstanceVar)
{
  sf_gateway_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_A2_TwoDOF_PID_task_space
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_A2_TwoDOF_PID_task_space();/* state var info */
...
extern void sf_internal_set_sim_state_c10_A2_TwoDOF_PID_task_space(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_A2_TwoDOF_PID_task_space();/* state var info */
  ...
  set_sim_state_c10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_A2_TwoDOF_PID_task_space
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c10_A2_TwoDOF_PID_task_space(S);
}

static void sf_opaque_set_sim_state_c10_A2_TwoDOF_PID_task_space(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c10_A2_TwoDOF_PID_task_space(S, st);
}

static void sf_opaque_terminate_c10_A2_TwoDOF_PID_task_space(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_A2_TwoDOF_PID_task_space
      ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_A2_TwoDOF_PID_task_space
    ((SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct *)utMalloc
    (sizeof(SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_A2_TwoDOF_PID_task_spaceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_A2_TwoDOF_PID_task_space;
...
void c10_A2_TwoDOF_PID_task_space_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_A2_TwoDOF_PID_task_space(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_A2_TwoDOF_PID_task_space(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_A2_TwoDOF_PID_task_space(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_A2_TwoDOF_PID_task_space_method_dispatcher.\n"
