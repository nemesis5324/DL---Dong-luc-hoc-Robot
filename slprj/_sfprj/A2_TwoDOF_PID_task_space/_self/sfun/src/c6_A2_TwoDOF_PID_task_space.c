...
#include "c6_A2_TwoDOF_PID_task_space.h"
...
static const char * c6_debug_family_names[6] = { "nargin", "nargout", "t", "Qd",
  "QPd", "QPPd" };

/* Function Declarations */
static void initialize_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void initialize_params_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void enable_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void disable_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void set_sim_state_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance, const mxArray
   *c6_st);
static void finalize_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void sf_gateway_c6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void initSimStructsc6_A2_TwoDOF_PID_task_space
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c6_QPPd, const char_T *c6_identifier, real_T
  c6_y[2]);
static void c6_b_emlrt_marshallIn(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct
...
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_A2_TwoDOF_PID_task_space,
  const char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance);
  ...
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_A2_TwoDOF_PID_task_space = 0U;
}
  ...
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_QPd)[2];
  real_T (*c6_QPPd)[2];
  c6_QPPd = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 3);
  c6_QPd = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c6_Qd = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_st = NULL;
  c6_st = NULL;
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_createcellmatrix(4, 1), false);
  for (c6_i0 = 0; c6_i0 < 2; c6_i0++) {
    c6_u[c6_i0] = (*c6_QPPd)[c6_i0];
  }
  ...
  for (c6_i2 = 0; c6_i2 < 2; c6_i2++) {
    c6_c_u[c6_i2] = (*c6_Qd)[c6_i2];
  }

  c6_d_y = NULL;
  sf_mex_assign(&c6_d_y, sf_mex_create("y", c6_c_u, 0, 0U, 1U, 0U, 1, 2), false);
  sf_mex_setcell(c6_y, 2, c6_d_y);
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_A2_TwoDOF_PID_task_space;
  c6_d_u = c6_hoistedGlobal;
  c6_e_y = NULL;
   ...
   *c6_st)
{
  ...
  c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 0)), "QPPd",
                      c6_dv0);
  for (c6_i3 = 0; c6_i3 < 2; c6_i3++) {
    (*c6_QPPd)[c6_i3] = c6_dv0[c6_i3];
  }

  c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)), "QPd",
                      c6_dv1);
  for (c6_i4 = 0; c6_i4 < 2; c6_i4++) {
    (*c6_QPd)[c6_i4] = c6_dv1[c6_i4];
  }

  c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)), "Qd",
                      c6_dv2);
  for (c6_i5 = 0; c6_i5 < 2; c6_i5++) {
    (*c6_Qd)[c6_i5] = c6_dv2[c6_i5];
  }

  chartInstance->c6_is_active_c6_A2_TwoDOF_PID_task_space =
    c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 3)),
    "is_active_c6_A2_TwoDOF_PID_task_space");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_A2_TwoDOF_PID_task_space(chartInstance);
  ...
  (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_b_QPd)[2];
  real_T (*c6_b_QPPd)[2];
  c6_b_QPPd = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 3);
  c6_b_QPd = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c6_b_Qd = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 1U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_t, 2U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_Qd, 3U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_QPd, 4U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_QPPd, 5U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c6_Qd[0] = c6_b_x;
  c6_Qd[1] = -1.5707963267948966 * c6_d_x;
  ...
  c6_QPd[0] = c6_f_x;
  c6_QPd[1] = 1.5707963267948966 * c6_h_x;
  ...
  c6_QPPd[0] = -c6_j_x;
  c6_QPPd[1] = 1.5707963267948966 * c6_l_x;
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -7);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i6 = 0; c6_i6 < 2; c6_i6++) {
    (*c6_b_Qd)[c6_i6] = c6_Qd[c6_i6];
  }

  for (c6_i7 = 0; c6_i7 < 2; c6_i7++) {
    (*c6_b_QPd)[c6_i7] = c6_QPd[c6_i7];
  }

  for (c6_i8 = 0; c6_i8 < 2; c6_i8++) {
    (*c6_b_QPPd)[c6_i8] = c6_QPPd[c6_i8];
  }
  ...
  for (c6_i9 = 0; c6_i9 < 2; c6_i9++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_Qd)[c6_i9], 1U);
  }

  for (c6_i10 = 0; c6_i10 < 2; c6_i10++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_QPd)[c6_i10], 2U);
  }

  for (c6_i11 = 0; c6_i11 < 2; c6_i11++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_QPPd)[c6_i11], 3U);
  }
}
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *)
    chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i12 = 0; c6_i12 < 2; c6_i12++) {
    c6_b_inData[c6_i12] = (*(real_T (*)[2])c6_inData)[c6_i12];
  }
  ...
  c6_y[2])
{
  ...
  c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_QPPd), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_QPPd);
}
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  chartInstance = (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *)
    chartInstanceVoid;
  c6_QPPd = sf_mex_dup(c6_mxArrayInData);
  ...
  for (c6_i15 = 0; c6_i15 < 2; c6_i15++) {
    (*(real_T (*)[2])c6_outData)[c6_i15] = c6_y[c6_i15];
  }
...
const mxArray *sf_c6_A2_TwoDOF_PID_task_space_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_A2_TwoDOF_PID_task_space), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_A2_TwoDOF_PID_task_space);
  return c6_y;
}
...
void sf_c6_A2_TwoDOF_PID_task_space_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_A2_TwoDOF_PID_task_space_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_A2_TwoDOF_PID_task_space_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_A2_TwoDOF_PID_task_space_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_A2_TwoDOF_PID_task_space(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[7],T\"QPPd\",},{M[1],M[6],T\"QPd\",},{M[1],M[5],T\"Qd\",},{M[8],M[0],T\"is_active_c6_A2_TwoDOF_PID_task_space\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_A2_TwoDOF_PID_task_space_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c6_Qd);
          _SFD_SET_DATA_VALUE_PTR(2U, *c6_QPd);
          _SFD_SET_DATA_VALUE_PTR(3U, *c6_QPPd);
        }
      }
    } else {
...
static void sf_opaque_initialize_c6_A2_TwoDOF_PID_task_space(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
  initialize_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_A2_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  enable_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_A2_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  disable_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_A2_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  sf_gateway_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_A2_TwoDOF_PID_task_space
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_A2_TwoDOF_PID_task_space();/* state var info */
...
extern void sf_internal_set_sim_state_c6_A2_TwoDOF_PID_task_space(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_A2_TwoDOF_PID_task_space();/* state var info */
  ...
  set_sim_state_c6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_A2_TwoDOF_PID_task_space
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_A2_TwoDOF_PID_task_space(S);
}

static void sf_opaque_set_sim_state_c6_A2_TwoDOF_PID_task_space(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c6_A2_TwoDOF_PID_task_space(S, st);
}

static void sf_opaque_terminate_c6_A2_TwoDOF_PID_task_space(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_A2_TwoDOF_PID_task_space
      ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_A2_TwoDOF_PID_task_space
    ((SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_A2_TwoDOF_PID_task_space(SimStruct *S)
{
  SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct *)utMalloc(sizeof
    (SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_A2_TwoDOF_PID_task_spaceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_A2_TwoDOF_PID_task_space;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_A2_TwoDOF_PID_task_space;
...
void c6_A2_TwoDOF_PID_task_space_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_A2_TwoDOF_PID_task_space(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_A2_TwoDOF_PID_task_space(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_A2_TwoDOF_PID_task_space(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_A2_TwoDOF_PID_task_space_method_dispatcher.\n"
