...
{
  extern unsigned int
    sf_A4_TwoDOF_PID_torque_joint_space_pos_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_A4_TwoDOF_PID_torque_joint_space_pos_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_A4_TwoDOF_PID_torque_joint_space_pos_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "A4_TwoDOF_PID_torque_joint_space_pos") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_A4_TwoDOF_PID_torque_joint_space_pos_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_A4_TwoDOF_PID_torque_joint_space_pos_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "A4_TwoDOF_PID_torque_joint_space_pos") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_A4_TwoDOF_PID_torque_joint_space_pos_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_A4_TwoDOF_PID_torque_joint_space_pos_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "A4_TwoDOF_PID_torque_joint_space_pos") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_A4_TwoDOF_PID_torque_joint_space_pos_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "A4_TwoDOF_PID_torque_joint_space_pos") == 0) {
    ...
    newRhs[1] = prhs[2];
    return
      sf_A4_TwoDOF_PID_torque_joint_space_pos_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_A4_TwoDOF_PID_torque_joint_space_pos_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"A4_TwoDOF_PID_torque_joint_space_pos")) {
    return(sf_A4_TwoDOF_PID_torque_joint_space_pos_method_dispatcher
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    A4_TwoDOF_PID_torque_joint_space_pos_terminator();
...
extern void A4_TwoDOF_PID_torque_joint_space_pos_register_exported_symbols
  (SimStruct* S);
extern void A4_TwoDOF_PID_torque_joint_space_pos_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  A4_TwoDOF_PID_torque_joint_space_pos_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      A4_TwoDOF_PID_torque_joint_space_pos_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    A4_TwoDOF_PID_torque_joint_space_pos_initializer();
  }
