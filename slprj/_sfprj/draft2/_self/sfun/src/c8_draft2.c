...
#include <stddef.h>
#include "blas.h"
#include "draft2_sfun.h"
#include "c8_draft2.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "draft2_sfun_debug_macros.h"
...
static const char * c8_debug_family_names[12] = { "C1", "S1", "C12", "S12", "L1",
  "L2", "J1", "nargin", "nargout", "Q", "QP", "XP" };

/* Function Declarations */
static void initialize_c8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void initialize_params_c8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void enable_c8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void disable_c8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_draft2(SFc8_draft2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_draft2(SFc8_draft2InstanceStruct
  *chartInstance);
static void set_sim_state_c8_draft2(SFc8_draft2InstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void sf_gateway_c8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void initSimStructsc8_draft2(SFc8_draft2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance, const
  mxArray *c8_XP, const char_T *c8_identifier, real_T c8_y[2]);
static void c8_b_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[2]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_draft2InstanceStruct *chartInstance);
static void c8_eml_xgemm(SFc8_draft2InstanceStruct *chartInstance, real_T c8_A[4],
  real_T c8_B[2], real_T c8_C[2], real_T c8_b_C[2]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_draft2, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_draft2InstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_xgemm(SFc8_draft2InstanceStruct *chartInstance, real_T
  c8_A[4], real_T c8_B[2], real_T c8_C[2]);
static void init_dsm_address_info(SFc8_draft2InstanceStruct *chartInstance);
...
static void initialize_c8_draft2(SFc8_draft2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_draft2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_draft2;
  ...
  const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_draft2 = c8_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_draft2");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_draft2(chartInstance);
...
static void sf_gateway_c8_draft2(SFc8_draft2InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_QP, 10U, c8_sf_marshallOut);
  ...
  for (c8_i5 = 0; c8_i5 < 4; c8_i5++) {
    c8_a[c8_i5] = c8_J1[c8_i5];
  }

  for (c8_i6 = 0; c8_i6 < 2; c8_i6++) {
    c8_b[c8_i6] = c8_QP[c8_i6];
  }
  ...
  for (c8_i9 = 0; c8_i9 < 4; c8_i9++) {
    c8_dv1[c8_i9] = c8_a[c8_i9];
  }

  for (c8_i10 = 0; c8_i10 < 2; c8_i10++) {
    c8_dv2[c8_i10] = c8_b[c8_i10];
  }

  for (c8_i11 = 0; c8_i11 < 4; c8_i11++) {
    c8_dv3[c8_i11] = c8_dv1[c8_i11];
  }

  for (c8_i12 = 0; c8_i12 < 2; c8_i12++) {
    c8_dv4[c8_i12] = c8_dv2[c8_i12];
  }
  ...
  for (c8_i13 = 0; c8_i13 < 2; c8_i13++) {
    (*c8_b_XP)[c8_i13] = c8_XP[c8_i13];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c8_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_draft2MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c8_i14 = 0; c8_i14 < 2; c8_i14++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_XP)[c8_i14], 1U);
  }

  for (c8_i15 = 0; c8_i15 < 2; c8_i15++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_QP)[c8_i15], 2U);
  }
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[2];
  const mxArray *c8_y = NULL;
  SFc8_draft2InstanceStruct *chartInstance;
  chartInstance = (SFc8_draft2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_draft2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c8_b_is_active_c8_draft2, const char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_draft2), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_draft2);
  return c8_y;
}
...
void sf_c8_draft2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1642496479U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3260902199U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2051857528U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2584115623U);
}

mxArray *sf_c8_draft2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VAzuxg6FtpSBQ1Sv9CGmR");
...
mxArray *sf_c8_draft2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_draft2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_draft2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"XP\",},{M[8],M[0],T\"is_active_c8_draft2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_draft2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_draft2InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_draft2MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_draft2MachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"XP");
...

        {
          ...
          real_T (*c8_XP)[2];
          real_T (*c8_QP)[2];
          c8_QP = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
          c8_XP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
          c8_Q = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c8_Q);
          _SFD_SET_DATA_VALUE_PTR(1U, *c8_XP);
          _SFD_SET_DATA_VALUE_PTR(2U, *c8_QP);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _draft2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "eCu04X1rk8tHSacEKqovEF";
}

static void sf_opaque_initialize_c8_draft2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_draft2InstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
  initialize_c8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_draft2(void *chartInstanceVar)
{
  enable_c8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_draft2(void *chartInstanceVar)
{
  disable_c8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_draft2(void *chartInstanceVar)
{
  sf_gateway_c8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_draft2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_draft2((SFc8_draft2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_draft2();/* state var info */
...
extern void sf_internal_set_sim_state_c8_draft2(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_draft2();/* state var info */
  ...
  set_sim_state_c8_draft2((SFc8_draft2InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_draft2(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_draft2(S);
}

static void sf_opaque_set_sim_state_c8_draft2(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_draft2(S, st);
}

static void sf_opaque_terminate_c8_draft2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_draft2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_draft2_optimization_info();
    }

    finalize_c8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_draft2((SFc8_draft2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_draft2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_draft2((SFc8_draft2InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_draft2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_draft2_optimization_info();
  ...
  ssSetChecksum0(S,(778790673U));
  ssSetChecksum1(S,(2870284589U));
  ssSetChecksum2(S,(519559794U));
  ssSetChecksum3(S,(2407420677U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_draft2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_draft2(SimStruct *S)
{
  SFc8_draft2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_draft2InstanceStruct *)utMalloc(sizeof
    (SFc8_draft2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_draft2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_draft2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_draft2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_draft2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_draft2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_draft2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_draft2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_draft2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_draft2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_draft2;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_draft2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_draft2;
...
void c8_draft2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_draft2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_draft2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_draft2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_draft2_method_dispatcher.\n"
