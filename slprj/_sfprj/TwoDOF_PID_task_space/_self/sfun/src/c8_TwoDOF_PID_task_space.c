...
#include <stddef.h>
#include "blas.h"
#include "TwoDOF_PID_task_space_sfun.h"
#include "c8_TwoDOF_PID_task_space.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "TwoDOF_PID_task_space_sfun_debug_macros.h"
...
static const char * c8_debug_family_names[12] = { "C1", "S1", "C12", "S12", "L1",
  "L2", "J1", "nargin", "nargout", "QP", "Q", "XP" };

/* Function Declarations */
static void initialize_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void initialize_params_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void enable_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void disable_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void set_sim_state_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void sf_gateway_c8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void initSimStructsc8_TwoDOF_PID_task_space
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c8_XP, const char_T *c8_identifier, real_T
  c8_y[2]);
static void c8_b_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
...
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[4]);
...
static void c8_eml_scalar_eg(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance);
static void c8_eml_xgemm(SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance,
  real_T c8_A[4], real_T c8_B[2], real_T c8_C[2], real_T c8_b_C[2]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_TwoDOF_PID_task_space, const
  char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_xgemm(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance, real_T c8_A[4], real_T c8_B[2], real_T c8_C[2]);
static void init_dsm_address_info(SFc8_TwoDOF_PID_task_spaceInstanceStruct
  *chartInstance);
  ...
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_TwoDOF_PID_task_space = 0U;
}
  ...
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_TwoDOF_PID_task_space;
  ...
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  for (c8_i1 = 0; c8_i1 < 2; c8_i1++) {
    (*c8_XP)[c8_i1] = c8_dv0[c8_i1];
  }

  chartInstance->c8_is_active_c8_TwoDOF_PID_task_space = c8_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
     "is_active_c8_TwoDOF_PID_task_space");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_TwoDOF_PID_task_space(chartInstance);
  ...
  (SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_XP, 11U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c8_i6 = 0; c8_i6 < 4; c8_i6++) {
    c8_a[c8_i6] = c8_J1[c8_i6];
  }

  for (c8_i7 = 0; c8_i7 < 2; c8_i7++) {
    c8_b[c8_i7] = c8_QP[c8_i7];
  }
  ...
  for (c8_i10 = 0; c8_i10 < 4; c8_i10++) {
    c8_dv1[c8_i10] = c8_a[c8_i10];
  }

  for (c8_i11 = 0; c8_i11 < 2; c8_i11++) {
    c8_dv2[c8_i11] = c8_b[c8_i11];
  }
  ...
  c8_b_eml_xgemm(chartInstance, c8_dv3, c8_dv4, c8_XP);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, -13);
  _SFD_SYMBOL_SCOPE_POP();
  for (c8_i14 = 0; c8_i14 < 2; c8_i14++) {
    (*c8_b_XP)[c8_i14] = c8_XP[c8_i14];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c8_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_TwoDOF_PID_task_spaceMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c8_i15 = 0; c8_i15 < 2; c8_i15++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_XP)[c8_i15], 2U);
  }
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc8_TwoDOF_PID_task_spaceInstanceStruct *)chartInstanceVoid;
  c8_mxArrayOutData = NULL;
  for (c8_i16 = 0; c8_i16 < 2; c8_i16++) {
    c8_b_inData[c8_i16] = (*(real_T (*)[2])c8_inData)[c8_i16];
  }
  ...
  c8_y[2])
{
  ...
  c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_XP), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_XP);
}
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  chartInstance = (SFc8_TwoDOF_PID_task_spaceInstanceStruct *)chartInstanceVoid;
  c8_XP = sf_mex_dup(c8_mxArrayInData);
  ...
  for (c8_i19 = 0; c8_i19 < 2; c8_i19++) {
    (*(real_T (*)[2])c8_outData)[c8_i19] = c8_y[c8_i19];
  }
  ...
  *c8_inData)
{
  ...
  c8_mxArrayOutData = NULL;
  c8_i20 = 0;
  for (c8_i21 = 0; c8_i21 < 2; c8_i21++) {
    for (c8_i22 = 0; c8_i22 < 2; c8_i22++) {
      c8_b_inData[c8_i22 + c8_i20] = (*(real_T (*)[4])c8_inData)[c8_i22 + c8_i20];
    }
  ...
  for (c8_i24 = 0; c8_i24 < 2; c8_i24++) {
    for (c8_i25 = 0; c8_i25 < 2; c8_i25++) {
      c8_u[c8_i25 + c8_i23] = c8_b_inData[c8_i25 + c8_i23];
    }
  ...
  real_T c8_y[4])
{
  ...
  int32_T c8_i26;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv6, 1, 0, 0U, 1, 0U, 2, 2, 2);
  for (c8_i26 = 0; c8_i26 < 4; c8_i26++) {
    c8_y[c8_i26] = c8_dv6[c8_i26];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  for (c8_i28 = 0; c8_i28 < 2; c8_i28++) {
    for (c8_i29 = 0; c8_i29 < 2; c8_i29++) {
      (*(real_T (*)[4])c8_outData)[c8_i29 + c8_i27] = c8_y[c8_i29 + c8_i27];
    }
...
const mxArray *sf_c8_TwoDOF_PID_task_space_get_eml_resolved_functions_info(void)
{
  ...
  real_T c8_A[4], real_T c8_B[2], real_T c8_C[2], real_T c8_b_C[2])
{
  ...
  for (c8_i30 = 0; c8_i30 < 2; c8_i30++) {
    c8_b_C[c8_i30] = c8_C[c8_i30];
  }

  for (c8_i31 = 0; c8_i31 < 4; c8_i31++) {
    c8_b_A[c8_i31] = c8_A[c8_i31];
  }

  for (c8_i32 = 0; c8_i32 < 2; c8_i32++) {
    c8_b_B[c8_i32] = c8_B[c8_i32];
  }
  ...
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId)
{
  ...
  int32_T c8_i33;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), &c8_i33, 1, 6, 0U, 0, 0U, 0);
  c8_y = c8_i33;
  sf_mex_destroy(&c8_u);
  return c8_y;
}
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_TwoDOF_PID_task_space), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_TwoDOF_PID_task_space);
  return c8_y;
}
  ...
  *chartInstance, real_T c8_A[4], real_T c8_B[2], real_T c8_C[2])
{
  ...
  for (c8_i34 = 0; c8_i34 < 2; c8_i34++) {
    ...
    for (c8_i36 = 0; c8_i36 < 2; c8_i36++) {
      c8_C[c8_i34] += c8_A[c8_i35 + c8_i34] * c8_B[c8_i36];
      c8_i35 += 2;
    }
  }
}
...
void sf_c8_TwoDOF_PID_task_space_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(966275454U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2397726015U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1060687350U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3679585555U);
}

mxArray *sf_c8_TwoDOF_PID_task_space_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yNr3pqYaaRstdvaeLKf4UB");
...
mxArray *sf_c8_TwoDOF_PID_task_space_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_TwoDOF_PID_task_space_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_TwoDOF_PID_task_space(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"XP\",},{M[8],M[0],T\"is_active_c8_TwoDOF_PID_task_space\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_TwoDOF_PID_task_space_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_TwoDOF_PID_task_spaceInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _TwoDOF_PID_task_spaceMachineNumber_,
           8,
           1,
           1,
           0,
        ...
        init_script_number_translation(_TwoDOF_PID_task_spaceMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_TwoDOF_PID_task_spaceMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _TwoDOF_PID_task_spaceMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "SaQo1ZdA4oS5YBarK7REJD";
}

static void sf_opaque_initialize_c8_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_TwoDOF_PID_task_space
    ((SFc8_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
  initialize_c8_TwoDOF_PID_task_space((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  enable_c8_TwoDOF_PID_task_space((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  disable_c8_TwoDOF_PID_task_space((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  sf_gateway_c8_TwoDOF_PID_task_space((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_TwoDOF_PID_task_space
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_TwoDOF_PID_task_space
    ((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_TwoDOF_PID_task_space();/* state var info */
...
extern void sf_internal_set_sim_state_c8_TwoDOF_PID_task_space(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_TwoDOF_PID_task_space();/* state var info */
  ...
  set_sim_state_c8_TwoDOF_PID_task_space
    ((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_TwoDOF_PID_task_space(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c8_TwoDOF_PID_task_space(S);
}

static void sf_opaque_set_sim_state_c8_TwoDOF_PID_task_space(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_TwoDOF_PID_task_space(S, st);
}

static void sf_opaque_terminate_c8_TwoDOF_PID_task_space(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_TwoDOF_PID_task_space_optimization_info();
    }

    finalize_c8_TwoDOF_PID_task_space((SFc8_TwoDOF_PID_task_spaceInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_TwoDOF_PID_task_space
    ((SFc8_TwoDOF_PID_task_spaceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_TwoDOF_PID_task_space(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_TwoDOF_PID_task_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_TwoDOF_PID_task_space_optimization_info();
  ...
  ssSetChecksum0(S,(1698006604U));
  ssSetChecksum1(S,(1330249683U));
  ssSetChecksum2(S,(4155145817U));
  ssSetChecksum3(S,(1205578044U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_TwoDOF_PID_task_space(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_TwoDOF_PID_task_space(SimStruct *S)
{
  SFc8_TwoDOF_PID_task_spaceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_TwoDOF_PID_task_spaceInstanceStruct *)utMalloc(sizeof
    (SFc8_TwoDOF_PID_task_spaceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_TwoDOF_PID_task_spaceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_TwoDOF_PID_task_space;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_TwoDOF_PID_task_space;
...
void c8_TwoDOF_PID_task_space_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_TwoDOF_PID_task_space(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_TwoDOF_PID_task_space(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_TwoDOF_PID_task_space(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_TwoDOF_PID_task_space_method_dispatcher.\n"
