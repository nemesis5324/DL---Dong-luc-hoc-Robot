...
#include <stddef.h>
#include "blas.h"
#include "QuinticTest_sfun.h"
#include "c1_QuinticTest.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "QuinticTest_sfun_debug_macros.h"
...
static void initialize_c1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance);
static void initialize_params_c1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance);
static void enable_c1_QuinticTest(SFc1_QuinticTestInstanceStruct *chartInstance);
static void disable_c1_QuinticTest(SFc1_QuinticTestInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_QuinticTest
  (SFc1_QuinticTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_QuinticTest
  (SFc1_QuinticTestInstanceStruct *chartInstance);
static void set_sim_state_c1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance);
static void sf_gateway_c1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance);
static void initSimStructsc1_QuinticTest(SFc1_QuinticTestInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct *chartInstance,
  const mxArray *c1_XPP, const char_T *c1_identifier, real_T c1_y[2]);
static void c1_b_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct *chartInstance,
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_d_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[43]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(const mxArray **c1_info);
static const mxArray *c1_emlrt_marshallOut(const char * c1_u);
static const mxArray *c1_b_emlrt_marshallOut(const uint32_T c1_u);
static void c1_eml_scalar_eg(SFc1_QuinticTestInstanceStruct *chartInstance);
static real_T c1_mpower(SFc1_QuinticTestInstanceStruct *chartInstance, real_T
  c1_a);
static real_T c1_b_mpower(SFc1_QuinticTestInstanceStruct *chartInstance, real_T
  c1_a);
static real_T c1_c_mpower(SFc1_QuinticTestInstanceStruct *chartInstance, real_T
  c1_a);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_QuinticTest, const char_T
  *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_QuinticTestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_QuinticTestInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_QuinticTest = 0U;
}
  ...
  (SFc1_QuinticTestInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_QuinticTest;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_QuinticTest = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
     "is_active_c1_QuinticTest");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_QuinticTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  c1_XPP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 3);
  c1_XP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c1_tf = (real_T (*)[43])ssGetInputPortSignal(chartInstance->S, 2);
  c1_Ps = (real_T (*)[88])ssGetInputPortSignal(chartInstance->S, 1);
  c1_X = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_QuinticTest(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_QuinticTestMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c1_i6 = 0; c1_i6 < 2; c1_i6++) {
    _SFD_DATA_RANGE_CHECK((*c1_X)[c1_i6], 1U);
  }

  for (c1_i7 = 0; c1_i7 < 88; c1_i7++) {
    _SFD_DATA_RANGE_CHECK((*c1_Ps)[c1_i7], 2U);
  }

  for (c1_i8 = 0; c1_i8 < 43; c1_i8++) {
  ...
  *chartInstance)
{
  ...
  c1_c_tf = (real_T (*)[43])ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_Ps = (real_T (*)[88])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i11 = 0; c1_i11 < 88; c1_i11++) {
    c1_Ps[c1_i11] = (*c1_b_Ps)[c1_i11];
  }

  for (c1_i12 = 0; c1_i12 < 43; c1_i12++) {
  ...
  do {
    ...
    if (c1_b_i <= c1_i14 - 1) {
      ...
      c1_tk = c1_b_t + c1_b_tf[_SFD_EML_ARRAY_BOUNDS_CHECK("tf", (int32_T)
        _SFD_INTEGER_CHECK("i", c1_i), 1, 43, 1, 0) - 1];
      ...
      if (guard1 == true) {
        ...
        if (CV_EML_IF(0, 1, 2, c1_i == c1_b_n)) {
          ...
          c1_b_t = c1_tk - c1_b_tf[_SFD_EML_ARRAY_BOUNDS_CHECK("tf", (int32_T)
            _SFD_INTEGER_CHECK("n", c1_b_n), 1, 43, 1, 0) - 1];
        }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_QuinticTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_QuinticTestInstanceStruct *)chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_QuinticTestInstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i30 = 0; c1_i30 < 43; c1_i30++) {
    c1_b_inData[c1_i30] = (*(real_T (*)[43])c1_inData)[c1_i30];
  }

  for (c1_i31 = 0; c1_i31 < 43; c1_i31++) {
    c1_u[c1_i31] = c1_b_inData[c1_i31];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 43), false);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, false);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  c1_mxArrayOutData = NULL;
  c1_i32 = 0;
  for (c1_i33 = 0; c1_i33 < 44; c1_i33++) {
    for (c1_i34 = 0; c1_i34 < 2; c1_i34++) {
      c1_b_inData[c1_i34 + c1_i32] = (*(real_T (*)[88])c1_inData)[c1_i34 +
        c1_i32];
    }
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 2, 44), false);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, false);
  return c1_mxArrayOutData;
}
  ...
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[43])
{
  ...
  int32_T c1_i38;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv4, 1, 0, 0U, 1, 0U, 1, 43);
  for (c1_i38 = 0; c1_i38 < 43; c1_i38++) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i39 = 0; c1_i39 < 43; c1_i39++) {
    (*(real_T (*)[43])c1_outData)[c1_i39] = c1_y[c1_i39];
  }

  sf_mex_destroy(&c1_mxArrayInData);
}

const mxArray *sf_c1_QuinticTest_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_QuinticTest), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_QuinticTest);
  return c1_y;
}
...
void sf_c1_QuinticTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_QuinticTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_QuinticTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_QuinticTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_QuinticTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"X\",},{M[1],M[8],T\"XP\",},{M[1],M[9],T\"XPP\",},{M[8],M[0],T\"is_active_c1_QuinticTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_QuinticTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_QuinticTestInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_QuinticTestMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_QuinticTestMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _QuinticTestMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_QuinticTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_QuinticTestInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*)
    chartInstanceVar);
  initialize_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_QuinticTest(void *chartInstanceVar)
{
  enable_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_QuinticTest(void *chartInstanceVar)
{
  disable_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_QuinticTest(void *chartInstanceVar)
{
  sf_gateway_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_QuinticTest(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_QuinticTest
    ((SFc1_QuinticTestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_QuinticTest();/* state var info */
...
extern void sf_internal_set_sim_state_c1_QuinticTest(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_QuinticTest();/* state var info */
  ...
  set_sim_state_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_QuinticTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_QuinticTest(S);
}

static void sf_opaque_set_sim_state_c1_QuinticTest(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_QuinticTest(S, st);
}

static void sf_opaque_terminate_c1_QuinticTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_QuinticTestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QuinticTest_optimization_info();
    }

    finalize_c1_QuinticTest((SFc1_QuinticTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_QuinticTest((SFc1_QuinticTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_QuinticTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_QuinticTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_QuinticTest_optimization_info();
...
static void mdlRTW_c1_QuinticTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_QuinticTest(SimStruct *S)
{
  SFc1_QuinticTestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_QuinticTestInstanceStruct *)utMalloc(sizeof
    (SFc1_QuinticTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_QuinticTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_QuinticTest;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_QuinticTest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_QuinticTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_QuinticTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_QuinticTest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_QuinticTest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_QuinticTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_QuinticTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_QuinticTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_QuinticTest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_QuinticTest;
...
void c1_QuinticTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_QuinticTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_QuinticTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_QuinticTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_QuinticTest_method_dispatcher.\n"
