...
static const char * c8_debug_family_names[14] = { "C1", "S1", "C12", "S12", "L1",
  "L2", "J1", "nargin", "nargout", "QP", "Q", "QPP", "XP", "XPP" };

/* Function Declarations */
static void initialize_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance);
static void initialize_params_c8_A5_Test(SFc8_A5_TestInstanceStruct
  *chartInstance);
static void enable_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance);
static void disable_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_A5_Test(SFc8_A5_TestInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_A5_Test(SFc8_A5_TestInstanceStruct
  *chartInstance);
static void set_sim_state_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance);
static void sf_gateway_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance);
static void initSimStructsc8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance, const
  mxArray *c8_XPP, const char_T *c8_identifier, real_T c8_y[2]);
static void c8_b_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[2]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_A5_TestInstanceStruct *chartInstance);
static void c8_eml_xgemm(SFc8_A5_TestInstanceStruct *chartInstance, real_T c8_A
  [4], real_T c8_B[2], real_T c8_C[2], real_T c8_b_C[2]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_A5_Test, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_A5_TestInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_xgemm(SFc8_A5_TestInstanceStruct *chartInstance, real_T
  c8_A[4], real_T c8_B[2], real_T c8_C[2]);
static void init_dsm_address_info(SFc8_A5_TestInstanceStruct *chartInstance);
...
static void initialize_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_A5_Test = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c8_XPP)[2];
  real_T (*c8_XP)[2];
  c8_XPP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c8_XP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  c8_st = NULL;
  c8_st = NULL;
  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_createcellmatrix(3, 1), false);
  for (c8_i0 = 0; c8_i0 < 2; c8_i0++) {
    c8_u[c8_i0] = (*c8_XP)[c8_i0];
  }
  ...
  for (c8_i1 = 0; c8_i1 < 2; c8_i1++) {
    c8_b_u[c8_i1] = (*c8_XPP)[c8_i1];
  }

  c8_c_y = NULL;
  sf_mex_assign(&c8_c_y, sf_mex_create("y", c8_b_u, 0, 0U, 1U, 0U, 1, 2), false);
  sf_mex_setcell(c8_y, 1, c8_c_y);
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_A5_Test;
  ...
  const mxArray *c8_st)
{
  ...
  c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 0)), "XP",
                      c8_dv0);
  for (c8_i2 = 0; c8_i2 < 2; c8_i2++) {
    (*c8_XP)[c8_i2] = c8_dv0[c8_i2];
  }

  c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)), "XPP",
                      c8_dv1);
  for (c8_i3 = 0; c8_i3 < 2; c8_i3++) {
    (*c8_XPP)[c8_i3] = c8_dv1[c8_i3];
  }

  chartInstance->c8_is_active_c8_A5_Test = c8_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 2)), "is_active_c8_A5_Test");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_A5_Test(chartInstance);
...
static void sf_gateway_c8_A5_Test(SFc8_A5_TestInstanceStruct *chartInstance)
{
  ...
  real_T (*c8_b_Q)[2];
  real_T (*c8_b_QP)[2];
  c8_b_XPP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
  c8_b_QPP = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 2);
  c8_b_XP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  c8_b_Q = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  c8_b_QP = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  for (c8_i4 = 0; c8_i4 < 2; c8_i4++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_QP)[c8_i4], 0U);
  }

  for (c8_i5 = 0; c8_i5 < 2; c8_i5++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_Q)[c8_i5], 1U);
  }

  chartInstance->c8_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  for (c8_i6 = 0; c8_i6 < 2; c8_i6++) {
    c8_QP[c8_i6] = (*c8_b_QP)[c8_i6];
  }

  for (c8_i7 = 0; c8_i7 < 2; c8_i7++) {
    c8_Q[c8_i7] = (*c8_b_Q)[c8_i7];
  }

  for (c8_i8 = 0; c8_i8 < 2; c8_i8++) {
    c8_QPP[c8_i8] = (*c8_b_QPP)[c8_i8];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c8_debug_family_names,
    c8_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_C1, 0U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_S1, 1U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_C12, 2U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_S12, 3U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_L1, 4U, c8_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_L2, 5U, c8_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_J1, 6U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 8U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_QP, 9U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_Q, 10U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_QPP, 11U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_XP, 12U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_XPP, 13U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c8_J1[0] = -0.2 * c8_S1 - 0.1442 * c8_S12;
  c8_J1[2] = -0.1442 * c8_S12;
  c8_J1[1] = 0.2 * c8_C1 + 0.1442 * c8_C12;
  c8_J1[3] = 0.1442 * c8_C12;
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 13);
  for (c8_i9 = 0; c8_i9 < 4; c8_i9++) {
    c8_a[c8_i9] = c8_J1[c8_i9];
  }

  for (c8_i10 = 0; c8_i10 < 2; c8_i10++) {
    c8_b[c8_i10] = c8_QP[c8_i10];
  }
  ...
  for (c8_i13 = 0; c8_i13 < 4; c8_i13++) {
    c8_dv2[c8_i13] = c8_a[c8_i13];
  }

  for (c8_i14 = 0; c8_i14 < 2; c8_i14++) {
    c8_dv3[c8_i14] = c8_b[c8_i14];
  }

  for (c8_i15 = 0; c8_i15 < 4; c8_i15++) {
    c8_dv4[c8_i15] = c8_dv2[c8_i15];
  }

  for (c8_i16 = 0; c8_i16 < 2; c8_i16++) {
    c8_dv5[c8_i16] = c8_dv3[c8_i16];
  }

  c8_b_eml_xgemm(chartInstance, c8_dv4, c8_dv5, c8_XP);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 14);
  for (c8_i17 = 0; c8_i17 < 4; c8_i17++) {
    c8_a[c8_i17] = c8_J1[c8_i17];
  }

  for (c8_i18 = 0; c8_i18 < 2; c8_i18++) {
    c8_b[c8_i18] = c8_QPP[c8_i18];
  }
  ...
  for (c8_i21 = 0; c8_i21 < 4; c8_i21++) {
    c8_dv6[c8_i21] = c8_a[c8_i21];
  }

  for (c8_i22 = 0; c8_i22 < 2; c8_i22++) {
    c8_dv7[c8_i22] = c8_b[c8_i22];
  }

  for (c8_i23 = 0; c8_i23 < 4; c8_i23++) {
    c8_dv8[c8_i23] = c8_dv6[c8_i23];
  }

  for (c8_i24 = 0; c8_i24 < 2; c8_i24++) {
    c8_dv9[c8_i24] = c8_dv7[c8_i24];
  }

  c8_b_eml_xgemm(chartInstance, c8_dv8, c8_dv9, c8_XPP);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, -14);
  _SFD_SYMBOL_SCOPE_POP();
  for (c8_i25 = 0; c8_i25 < 2; c8_i25++) {
    (*c8_b_XP)[c8_i25] = c8_XP[c8_i25];
  }

  for (c8_i26 = 0; c8_i26 < 2; c8_i26++) {
    (*c8_b_XPP)[c8_i26] = c8_XPP[c8_i26];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_A5_TestMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c8_i27 = 0; c8_i27 < 2; c8_i27++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_XP)[c8_i27], 2U);
  }

  for (c8_i28 = 0; c8_i28 < 2; c8_i28++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_QPP)[c8_i28], 3U);
  }

  for (c8_i29 = 0; c8_i29 < 2; c8_i29++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_XPP)[c8_i29], 4U);
  }
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[2];
  const mxArray *c8_y = NULL;
  SFc8_A5_TestInstanceStruct *chartInstance;
  chartInstance = (SFc8_A5_TestInstanceStruct *)chartInstanceVoid;
  c8_mxArrayOutData = NULL;
  for (c8_i30 = 0; c8_i30 < 2; c8_i30++) {
    c8_b_inData[c8_i30] = (*(real_T (*)[2])c8_inData)[c8_i30];
  }
  ...
  mxArray *c8_XPP, const char_T *c8_identifier, real_T c8_y[2])
{
  ...
  c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_XPP), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_XPP);
}
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[2])
{
  ...
  int32_T c8_i32;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv10, 1, 0, 0U, 1, 0U, 1, 2);
  for (c8_i32 = 0; c8_i32 < 2; c8_i32++) {
    c8_y[c8_i32] = c8_dv10[c8_i32];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_A5_TestInstanceStruct *chartInstance;
  chartInstance = (SFc8_A5_TestInstanceStruct *)chartInstanceVoid;
  c8_XPP = sf_mex_dup(c8_mxArrayInData);
  ...
  for (c8_i33 = 0; c8_i33 < 2; c8_i33++) {
    (*(real_T (*)[2])c8_outData)[c8_i33] = c8_y[c8_i33];
  }
  ...
  *c8_inData)
{
  ...
  for (c8_i35 = 0; c8_i35 < 2; c8_i35++) {
    for (c8_i36 = 0; c8_i36 < 2; c8_i36++) {
      c8_b_inData[c8_i36 + c8_i34] = (*(real_T (*)[4])c8_inData)[c8_i36 + c8_i34];
    }
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[4])
{
  ...
  int32_T c8_i40;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv11, 1, 0, 0U, 1, 0U, 2, 2, 2);
  for (c8_i40 = 0; c8_i40 < 4; c8_i40++) {
    c8_y[c8_i40] = c8_dv11[c8_i40];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_A5_TestInstanceStruct *chartInstance;
  chartInstance = (SFc8_A5_TestInstanceStruct *)chartInstanceVoid;
  c8_J1 = sf_mex_dup(c8_mxArrayInData);
  c8_identifier = c8_varName;
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_J1), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_J1);
  c8_i41 = 0;
  for (c8_i42 = 0; c8_i42 < 2; c8_i42++) {
    for (c8_i43 = 0; c8_i43 < 2; c8_i43++) {
      (*(real_T (*)[4])c8_outData)[c8_i43 + c8_i41] = c8_y[c8_i43 + c8_i41];
    }
...
const mxArray *sf_c8_A5_Test_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId)
{
  ...
  int32_T c8_i47;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), &c8_i47, 1, 6, 0U, 0, 0U, 0);
  c8_y = c8_i47;
  sf_mex_destroy(&c8_u);
  return c8_y;
}
  ...
  const mxArray *c8_b_is_active_c8_A5_Test, const char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_A5_Test), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_A5_Test);
  return c8_y;
}
  ...
  c8_A[4], real_T c8_B[2], real_T c8_C[2])
{
  ...
  int32_T c8_i50;
  (void)chartInstance;
  for (c8_i48 = 0; c8_i48 < 2; c8_i48++) {
    c8_C[c8_i48] = 0.0;
    c8_i49 = 0;
    for (c8_i50 = 0; c8_i50 < 2; c8_i50++) {
      c8_C[c8_i48] += c8_A[c8_i49 + c8_i48] * c8_B[c8_i50];
      c8_i49 += 2;
    }
  }
}
...
void sf_c8_A5_Test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_A5_Test_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_A5_Test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_A5_Test_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_A5_Test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"XP\",},{M[1],M[9],T\"XPP\",},{M[8],M[0],T\"is_active_c8_A5_Test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_A5_Test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_A5_TestInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_A5_TestMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_A5_TestMachineNumber_,
...

        {
          ...
          real_T (*c8_XPP)[2];
          c8_XPP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 2);
          c8_QPP = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 2);
          c8_XP = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
          c8_Q = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
          c8_QP = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c8_QP);
          _SFD_SET_DATA_VALUE_PTR(1U, *c8_Q);
          _SFD_SET_DATA_VALUE_PTR(2U, *c8_XP);
          _SFD_SET_DATA_VALUE_PTR(3U, *c8_QPP);
          _SFD_SET_DATA_VALUE_PTR(4U, *c8_XPP);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _A5_TestMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c8_A5_Test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_A5_TestInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
  initialize_c8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_A5_Test(void *chartInstanceVar)
{
  enable_c8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_A5_Test(void *chartInstanceVar)
{
  disable_c8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_A5_Test(void *chartInstanceVar)
{
  sf_gateway_c8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_A5_Test(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_A5_Test((SFc8_A5_TestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_A5_Test();/* state var info */
...
extern void sf_internal_set_sim_state_c8_A5_Test(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_A5_Test();/* state var info */
  ...
  set_sim_state_c8_A5_Test((SFc8_A5_TestInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_A5_Test(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_A5_Test(S);
}

static void sf_opaque_set_sim_state_c8_A5_Test(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_A5_Test(S, st);
}

static void sf_opaque_terminate_c8_A5_Test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_A5_TestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_A5_Test_optimization_info();
    }

    finalize_c8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_A5_Test((SFc8_A5_TestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_A5_Test(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_A5_Test((SFc8_A5_TestInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_A5_Test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_A5_Test_optimization_info();
...
static void mdlRTW_c8_A5_Test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_A5_Test(SimStruct *S)
{
  SFc8_A5_TestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_A5_TestInstanceStruct *)utMalloc(sizeof
    (SFc8_A5_TestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_A5_TestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_A5_Test;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_A5_Test;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_A5_Test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_A5_Test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_A5_Test;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_A5_Test;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_A5_Test;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_A5_Test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_A5_Test;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_A5_Test;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_A5_Test;
...
void c8_A5_Test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_A5_Test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_A5_Test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_A5_Test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_A5_Test_method_dispatcher.\n"
