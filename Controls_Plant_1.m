% Adams / MATLAB Interface - Release 2017.1.0
...
elseif strcmp(machine, 'PCWIN64')
   ...
   [flag, topdir]=system('adams2017_1 -top');
if flag == 0
  ...
  addpath( 'E:\MSC~1.SOF\Adams\2017_1\controls/win64' ) ;
  addpath( 'E:\MSC~1.SOF\Adams\2017_1\controls/win32' ) ;
  addpath( 'E:\MSC~1.SOF\Adams\2017_1\controls/matlab' ) ;
  addpath( 'E:\MSC~1.SOF\Adams\2017_1\controls/utils' ) ;
  ADAMS_sysdir = 'E:\MSC~1.SOF\Adams\2017_1\' ;
end
ADAMS_exec = '' ;
ADAMS_host = 'phs_pc' ;
ADAMS_cwd ='G:\Dropbox\6-Cao Hoc\Ky2\4 - DL - Dong luc hoc Robot\DL_Matlab'  ;
ADAMS_prefix = 'Controls_Plant_1' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
ADAMS_version = '2017_1' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'GAMMA1!GAMMA2' ;
ADAMS_outputs = 'Px!Py!Q1!Q2!QP1!QP2' ;
